...
public class UpdateInstructorDetails extends JFrame implements ActionListener{
    
    JTextField tffaculty, tfaddress, tfphone, tfemail, tfsubject;
    JLabel labelid;
    JButton submit, cancel;
    Choice cid;
    
    public UpdateInstructorDetails() {
        ...
        lblid.setFont(new Font(Font.SANS_SERIF, Font.PLAIN, 20));
        add(lblid);
        ...
        labelname.setFont(new Font(Font.SANS_SERIF, Font.PLAIN, 18));
        add(labelname);
        ...
        labelmname.setBounds(230, 200, 150, 30);
        labelmname.setFont(new Font("Tahoma", Font.PLAIN, 18));
        add(labelmname);
        
        //Roll Number
        JLabel lblids = new JLabel("ID");
        lblids.setBounds(400, 200, 200, 30);
        lblids.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 20));
        add(lblids);
        
        labelid = new JLabel();
        labelid.setBounds(600, 200, 200, 30);
        ...
        labeldob.setBounds(230, 250, 150, 30);
        ...
        tfsubject.setBounds(600, 400, 150, 30);
        add(tfsubject);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update instructor set address='"+address+"', phone='"+phone+"', email='"+email+"', faculty='"+faculty+"', subject='"+subject+"' where id='"+id+"'";
                Conn con = new Conn();
